...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        "Error de conexión. Asegúrate de que el servidor backend esté encendido."
      );
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/95 rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-teal-500 to-teal-600 text-white font-semibold py-3 rounded-lg hover:from-teal-600 hover:to-teal-700 transform hover:-translate-y-0.5 transition-all duration-200 shadow-md hover:shadow-lg"
            >
              Iniciar Sesión
            </button>
          </form>
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full bg-white border-2 border-gray-300 text-gray-700 font-semibold py-3 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 shadow-sm hover:shadow-md"
          >
