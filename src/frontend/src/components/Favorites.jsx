      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-700 font-medium">
            Aquí tus mascotas guardadas como favoritos ¡Talvez una de ellas sea
        ...
        {favorites.length > 0 ? (
              ...
              >
                ...
                <div className="relative h-64 bg-gray-200">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://via.placeholder.com/400x300/a8e6cf/000000?text=" +
                        pet.name;
                    }}
                  />
                  {/* Botón de eliminar */}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-start gap-2 mb-3 text-sm text-gray-700">
                    ...
                    <span>{pet.shelter?.name || "Refugio desconocido"}</span>
                  </div>
          ...
          <div className="text-center py-20">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Explora nuestras mascotas y agrega tus favoritas haciendo clic en
              el corazón
            </p>
            <Link
              to="/pets-list"
